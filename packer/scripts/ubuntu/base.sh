...
sudo apt-get -y install git curl auditd audispd-plugins libcurl3 bridge-utils bundler default-jre-headless unzip wget python-setuptools python-protobuf cgroup-bin ruby1.9.1
